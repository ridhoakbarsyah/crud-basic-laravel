...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('student') }}" method="post">
        {!! csrf_field() !!}
        <label>NIM</label></br>
        <input type="number" name="nim" id="nim" class="form-control" autofocus value="{{ old('nim') }}"></br>
        @if($errors->has('nim'))
        ...
        <input type="number" name="mobile" id="mobile" class="form-control" value="{{ old('mobile') }}"></br>
        @if($errors->has('address'))
